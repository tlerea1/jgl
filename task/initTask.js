 ...
 * @param task the phase object to be initialized, (cannot be null)
 * @param startSegmentCallback the callback function for a start Segment event. (required)
 * @param screenUpdateCallback the callback function for a screen update event. (required)
 * @param trialResponseCallback the callback function for a response event. (optional)
 * @param startTrialCallback the callback function for a start Trial event. (optional)
 * @param endTrialCallback the callback function for a end Trial event. (optional)
 * @param startBlockCallback the callback function for a start Block event. (optional)
 * @param randCallback the callback function to randomize the parameters in a block (optional)
